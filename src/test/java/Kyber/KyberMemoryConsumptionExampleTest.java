...
//            System.gc();
//            runKyberTest(KyberParameterSpec.kyber512);
//            memoryUsage512[i] = getMemoryUsage();
//        }
//
//        // Warm-up Kyber768
//        for (int i = 0; i < warmUpIterations; i++) {
...
//            System.gc();
//            runKyberTest(KyberParameterSpec.kyber768);
//            memoryUsage768[i] = getMemoryUsage();
//        }
//
//        // Warm-up Kyber1024
//        for (int i = 0; i < warmUpIterations; i++) {
...
//            System.gc();
//            runKyberTest(KyberParameterSpec.kyber1024);
//            memoryUsage1024[i] = getMemoryUsage();
//        }
//
//        // Write results to a file
...
//    }
//
//    private void runKyberTest(KyberParameterSpec kyberParameterSpec) throws Exception {
//        // Run garbage collection before each measurement
//        //System.gc();
//        // Generate key pair and encapsulation for Kyber
